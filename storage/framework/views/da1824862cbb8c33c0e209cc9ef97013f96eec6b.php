                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" id="issue-name" class="form-control form-control-alternative" placeholder="C# bank application" name="issue-name" value="<?php echo e(old('issue-name')); ?>" required>
                                    <?php $__errorArgs = ['issue-name'];
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <textarea id="issue-description" name="issue-description" class="form-control form-control-alternative" rows="3" placeholder="Fill in this field with a brief description of your project" required><?php echo e(old('issue-description')); ?></textarea>
                                    <?php $__errorArgs = ['issue-description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <select
                                        name="issue-project"
                                        id="issue-project"
                                        class="form-control form-control-alternative <?php $__errorArgs = ['issue-project'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                            ...
                            <div class="col-lg-4">
                                <div class="form-group focused">
                                    ...
                                    <select
                                        name="issue-type"
                                        id="issue-type"
                                        class="form-control form-control-alternative <?php $__errorArgs = ['issue-type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                            ...
                            <div class="col-lg-4">
                                <div class="form-group focused">
                                    ...
                                    <select
                                        name="issue-priority"
                                        id="issue-priority"
                                        class="form-control form-control-alternative <?php $__errorArgs = ['issue-priority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__errorArgs = ['issue-priority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group focused">
                                    ...
                                    <select
                                        name="issue-status"
                                        id="issue-status"
                                        class="form-control form-control-alternative <?php $__errorArgs = ['issue-status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bugtracker\resources\views/issues/create.blade.php ENDPATH**/ ?>